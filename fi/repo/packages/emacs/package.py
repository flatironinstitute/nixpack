# import sys
# import spack.pkg.builtin.emacs as builtin

# class Emacs(builtin.Emacs):
#     version('28.1', sha256='1439bf7f24e5769f35601dbf332e74dfc07634da6b1e9500af67188a92340a28')
#     depends_on('gcc@10: +strip languages=jit', when="+native")
...
class Emacs(AutotoolsPackage, GNUMirrorPackage):
    ...
    variant('json', default=False, description="Enable native json support")
    ...
    depends_on('gcc@10: languages=jit', when="+native")
