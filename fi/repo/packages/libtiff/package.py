...
class Libtiff(CMakePackage, AutotoolsPackage):
    ...
    variant("tiff-docs", default=False, description="build the docs")
    variant("sphinx", default=False, description="build the sphinx documentation", when='+tiff-docs')
