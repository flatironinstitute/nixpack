...
class PyGevent(PythonPackage):
    ...
    version("22.10.2", sha256="1ca01da176ee37b3527a2702f7d40dbc9ffb8cfc7be5a03bfa4f9eec45e55c46")
    ...
    depends_on("python@:3.10", when="@:21", type=("build", "run"))
    ...
    depends_on("py-cython@3.0.0a11:", when="@22:", type="build")
    ...
    depends_on("py-greenlet@2.0.0:", when="@22:", type=("build", "run"))
    depends_on("py-greenlet@1.1:1", when="@21.8:21", type=("build", "run"))
    depends_on("py-greenlet@0.4.17:1", when="@20.12:21", type=("build", "run"))
