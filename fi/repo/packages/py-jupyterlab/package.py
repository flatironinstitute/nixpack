...
class PyJupyterlab(PythonPackage):
    ...
    version("3.6.5", sha256="ac0cb19756be1d1e14b2be1f23c603de46e0f0113960fce9888889ca55ae8923")
    ...
    with when("@:3"):
        ...
        depends_on("py-jupyterlab-server@2.19:2", when="@3.6:", type=("build", "run"))
        depends_on("py-jupyterlab-server@2.10:2", when="@3.3:3.4", type=("build", "run"))
        ...
        depends_on("py-jupyter-server@1.16:2", when="@3.6:", type=("build", "run"))
